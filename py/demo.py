...
cnxn = pyodbc.connect('DRIVER=/opt/homebrew/Cellar/msodbcsql17@17.10.6.1/17.10.6.1/lib/libmsodbcsql.17.dylib;SERVER='+server+';DATABASE='+database+';UID='+username+';PWD='+ password+';')
cursor = cnxn.cursor()  
