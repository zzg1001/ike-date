...
TRUNCATE table ODS_HANA.dbo.digital_brain_purchase_plan_amount;

INSERT  into ODS_HANA.dbo.digital_brain_purchase_plan_amount
...
select A.id                                          as contract_id
		       ...
		       ,GETDATE() etl_time
		   -- into ODS_HANA.dbo.digital_brain_purchase_plan_amount
       from ODS_SRM.dbo.ct_contract A
