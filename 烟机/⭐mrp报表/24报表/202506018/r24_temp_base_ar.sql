...
----------------------------------------------
   ...
   select  a.DELNR1    as require_no         -- 预留号                
	   ...
	   -- ,b.schedule_date
		  ...
		  ,b.current_process_no + '/' + b.current_process_desc + '/' + b.current_key_dept_desc as prod_order_current_point --当前节点 1
	into #supply_fe  -- #d
	from ODS_HANA.dbo.mrp_ww a
...
----------------------------------------------
   ...
   select  a.require_no
	...
	from (
				...
				ORDER BY a.RSNUM, a.RSPOS, a.WERKS
		   )a
	 where a.require_quantity > 0;
	
	-- Report0624.dbo.r24_assemble_require_detail a
